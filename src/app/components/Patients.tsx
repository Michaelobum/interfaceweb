...
const STATUS_CONFIG = {
  active:   { label: 'Activo',   bg: 'bg-emerald-50 dark:bg-emerald-900/20', text: 'text-emerald-700 dark:text-emerald-300', border: 'border-emerald-200 dark:border-emerald-700/50', dot: 'bg-emerald-500' },
  inactive: { label: 'Inactivo', bg: 'bg-gray-50 dark:bg-gray-800',          text: 'text-gray-500 dark:text-gray-400',       border: 'border-gray-200 dark:border-gray-700',          dot: 'bg-gray-400'    },
  overdue:  { label: 'Moroso',   bg: 'bg-red-50 dark:bg-red-900/20',         text: 'text-red-700 dark:text-red-300',         border: 'border-red-200 dark:border-red-700/50',         dot: 'bg-red-500'     },
};
        ...
        <div className="max-w-5xl mx-auto p-4 sm:p-6 space-y-5">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div>
              ...
              <h1 className="text-2xl font-bold text-gray-900 dark:text-white tracking-tight">Perfil del Paciente</h1>
              <p className="text-sm text-gray-500 dark:text-gray-400 mt-0.5">Información clínica y financiera</p>
            </div>
            <div className="flex items-center gap-2 flex-wrap">
              ...
              <button className="inline-flex items-center gap-2 px-3.5 py-2.5 border border-gray-200 dark:border-gray-700 text-gray-700 dark:text-gray-300 text-sm font-semibold rounded-xl hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors">
              ...
              <div className="flex-1 min-w-0">
                <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-3">
                  <div>
                    ...
                    <p className="text-sm text-gray-400 dark:text-gray-500 mt-0.5">{selectedPatient.age} años · Paciente desde 2024</p>
                  </div>
                  <StatusBadge status={selectedPatient.status} />
                </div>
                <div className="mt-4 flex flex-col sm:flex-row flex-wrap gap-3 text-sm text-gray-500 dark:text-gray-400">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
            <div className="bg-white dark:bg-gray-900 rounded-2xl p-4 border border-gray-100 dark:border-gray-800 shadow-sm">
              ...
              <p className="text-xs text-gray-400 dark:text-gray-500 mb-0.5">Última Visita</p>
              <p className="text-sm font-bold text-gray-900 dark:text-white">{format(selectedPatient.lastVisit, 'dd MMM yyyy', { locale: es })}</p>
            </div>
            <div className="bg-white dark:bg-gray-900 rounded-2xl p-4 border border-gray-100 dark:border-gray-800 shadow-sm">
              <div className="flex items-center justify-between mb-2">
              ...
              <p className="text-xs text-gray-400 dark:text-gray-500 mb-0.5">Próxima Cita</p>
            ...
            <div className="bg-white dark:bg-gray-900 rounded-2xl p-4 border border-gray-100 dark:border-gray-800 shadow-sm">
              ...
              <p className="text-xs text-gray-400 dark:text-gray-500 mb-0.5">Tratamientos</p>
              <p className="text-sm font-bold text-gray-900 dark:text-white">12</p>
            </div>
            <div className={`bg-white dark:bg-gray-900 rounded-2xl p-4 border shadow-sm ${selectedPatient.balance > 0 ? 'border-red-100' : 'border-gray-100 dark:border-gray-800'}`}>
              <div className="flex items-center justify-between mb-2">
                <div className={`w-8 h-8 rounded-xl flex items-center justify-center ${selectedPatient.balance > 0 ? 'bg-red-50 dark:bg-red-900/20' : 'bg-emerald-50 dark:bg-emerald-900/20'}`}>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
            ...
            <div className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-100 dark:border-gray-800 shadow-sm overflow-hidden">
              <div className="px-5 py-4 border-b border-gray-100 dark:border-gray-800">
                <h3 className="text-sm font-bold text-gray-800 dark:text-gray-100">Historial Clínico</h3>
              </div>
                ...
                {medicalHistory.map((record, i) => (
                  <div key={i} className="px-5 py-4 flex items-start gap-4">
                    <div className="text-center shrink-0">
                      ...
                      <p className="text-xs text-gray-400 dark:text-gray-500">{format(new Date(record.date), 'MMM', { locale: es })}</p>
                    </div>
                    <div className="flex-1 min-w-0">
                      <p className="text-sm font-semibold text-gray-900 dark:text-white">{record.treatment}</p>
                      <p className="text-xs text-gray-500 dark:text-gray-400 mt-0.5">{record.doctor}</p>
                      <p className="text-xs text-gray-400 dark:text-gray-500 mt-0.5 italic">{record.notes}</p>
                    </div>
            ...
            <div className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-100 dark:border-gray-800 shadow-sm overflow-hidden">
              <div className="px-5 py-4 border-b border-gray-100 dark:border-gray-800">
                <h3 className="text-sm font-bold text-gray-800 dark:text-gray-100">Historial de Pagos</h3>
              </div>
              <div className="divide-y divide-gray-50 dark:divide-gray-800">
                {paymentHistory.map((payment, i) => (
                  <div key={i} className="px-5 py-4 flex items-center justify-between gap-4">
                    <div>
                      <p className="text-sm font-semibold text-gray-900 dark:text-white">{payment.concept}</p>
                    ...
                    <div className="text-right shrink-0">
                      ...
                      <span className="text-xs font-semibold text-emerald-600 bg-emerald-50 dark:bg-emerald-900/20 px-2 py-0.5 rounded-full">Pagado</span>
                    </div>
                  </div>
                ))}
              </div>
          ...
          {/* Additional Info */}
          <div className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-100 dark:border-gray-800 shadow-sm p-5 sm:p-6">
            <h3 className="text-sm font-bold text-gray-800 dark:text-gray-100 mb-4">Información Médica Adicional</h3>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {[
                { icon: AlertCircle, label: 'Alergias', value: 'Penicilina, Látex', color: 'text-red-500 bg-red-50 dark:bg-red-900/20' },
                { icon: Heart, label: 'Grupo Sanguíneo', value: 'O+', color: 'text-pink-500 bg-pink-50' },
                { icon: FileText, label: 'Condiciones Médicas', value: 'Hipertensión controlada', color: 'text-amber-500 bg-amber-50 dark:bg-amber-900/20' },
                { icon: Shield, label: 'Seguro Dental', value: 'Sanitas · Póliza #12345678', color: 'text-blue-500 bg-blue-50 dark:bg-blue-900/30' },
              ].map(({ icon: Icon, label, value, color }) => (
                <div key={label} className="flex items-start gap-3 bg-gray-50 dark:bg-gray-800 rounded-xl p-4">
  ...
  return (
    <div className="min-h-screen bg-gray-50/60 dark:bg-gray-950">
      <div className="max-w-7xl mx-auto p-4 sm:p-6 space-y-5">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            <h1 className="text-2xl font-bold text-gray-900 dark:text-white tracking-tight">Pacientes</h1>
            <p className="text-sm text-gray-500 dark:text-gray-400 mt-0.5">Gestión de expedientes clínicos</p>
          </div>
          <button
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
          ...
          <div className="bg-white dark:bg-gray-900 rounded-2xl p-5 border border-gray-100 dark:border-gray-800 shadow-sm">
            <div className="flex items-center justify-between mb-3">
              ...
              <span className="text-xs font-medium text-emerald-600 bg-emerald-50 dark:bg-emerald-900/20 px-2 py-0.5 rounded-full">{activeCount} pac.</span>
            </div>
            <p className="text-xs text-gray-500 dark:text-gray-400 mb-0.5">Activos</p>
          ...
          <div className="bg-white dark:bg-gray-900 rounded-2xl p-5 border border-red-100 shadow-sm">
            <div className="flex items-center justify-between mb-3">
              ...
              <span className="text-xs font-medium text-red-500 bg-red-50 dark:bg-red-900/20 px-2 py-0.5 rounded-full">{overdueCount} moroso</span>
            </div>
            <p className="text-xs text-gray-500 dark:text-gray-400 mb-0.5">Morosos</p>
            <p className="text-xl font-bold text-red-600">{overdueCount}</p>
          </div>

          <div className="bg-white dark:bg-gray-900 rounded-2xl p-5 border border-amber-100 dark:border-amber-800/40 shadow-sm">
            <div className="flex items-center justify-between mb-3">
            ...
            <p className="text-xs text-gray-500 dark:text-gray-400 mb-0.5">Saldo Total</p>
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-gray-100 dark:border-gray-800">
                  ...
                  <th className="px-5 py-3.5 text-left text-xs font-semibold text-gray-400 dark:text-gray-500 uppercase tracking-wider">Contacto</th>
                  <th className="px-5 py-3.5 text-left text-xs font-semibold text-gray-400 dark:text-gray-500 uppercase tracking-wider hidden lg:table-cell">Última Visita</th>
                  <th className="px-5 py-3.5 text-left text-xs font-semibold text-gray-400 dark:text-gray-500 uppercase tracking-wider hidden lg:table-cell">Próxima Cita</th>
                  ...
                  <th className="px-5 py-3.5 text-right text-xs font-semibold text-gray-400 dark:text-gray-500 uppercase tracking-wider">Saldo</th>
                  ...
                  >
                    <td className="px-5 py-4">
                      <div className="flex items-center gap-2.5">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-gray-400 dark:text-gray-500">{patient.age} años</p>
                        </div>
                      </div>
                    </td>
                    <td className="px-5 py-4">
                      <p className="text-sm text-gray-700 dark:text-gray-300">{patient.phone}</p>
                      <p className="text-xs text-gray-400 dark:text-gray-500 mt-0.5">{patient.email}</p>
                    </td>
                    ...
                    <td className="px-5 py-4 text-sm hidden lg:table-cell">
                      {patient.nextAppointment
                        ? <span className="text-gray-700 dark:text-gray-300">{format(patient.nextAppointment, 'dd MMM yyyy', { locale: es })}</span>
                        : <span className="text-gray-400 dark:text-gray-500 italic">Sin programar</span>}
                    </td>
                    ...
                    <td className="px-5 py-4">
                      <div className="flex items-center justify-end gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                        <button onClick={e => { e.stopPropagation(); navigate(`/patients/${patient.id}`); }} className="p-2 rounded-lg hover:bg-blue-100 dark:hover:bg-blue-900/30 text-gray-400 hover:text-[#0066CC] transition-colors">
                          <FileText className="w-4 h-4" />
                        </button>
                        ...
                        <button onClick={e => e.stopPropagation()} className="p-2 rounded-lg hover:bg-red-50 dark:hover:bg-red-900/20 text-gray-400 hover:text-red-500 transition-colors">
              ...
              >
                ...
                <div className="mt-3 flex items-end justify-between">
                  ...
                  <div className="flex items-center gap-1">
                    ...
                    <button onClick={e => e.stopPropagation()} className="p-1.5 rounded-lg bg-gray-100 dark:bg-gray-700 hover:bg-red-100 dark:hover:bg-red-900/30 text-gray-500 dark:text-gray-400 hover:text-red-500 transition-colors">
          ...
          <div className="bg-white dark:bg-gray-900 w-full sm:rounded-2xl sm:max-w-2xl flex flex-col shadow-2xl" style={{ maxHeight: '95vh' }}>
            ...
            <div className="flex items-center justify-between px-5 py-4 border-b border-gray-100 dark:border-gray-800 shrink-0">
              <div>
                ...
                <p className="text-xs text-gray-400 dark:text-gray-500">Completa los datos del expediente</p>
              </div>
              <button
            ...
            <div className="overflow-y-auto flex-1 px-5 py-5 space-y-5">
              ...
              {/* Datos personales */}
              <div>
                <p className="text-xs font-semibold text-gray-400 dark:text-gray-500 uppercase tracking-wider mb-3">Datos Personales</p>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  <div className="sm:col-span-2">
                    ...
                    <input
                      ...
                      className="w-full px-3.5 py-2.5 text-sm border border-gray-200 rounded-xl bg-gray-50 focus:outline-none focus:ring-2 focus:ring-[#0066CC]/30 focus:border-[#0066CC] transition-all dark:border-gray-700 dark:bg-gray-800 dark:text-gray-100"
                    />
                  </div>
                  <div>
                  ...
                  <div>
                    <label className="block text-xs font-semibold text-gray-500 dark:text-gray-400 mb-1.5">Odontólogo asignado</label>
                    <select
              ...
              {/* Contacto */}
              <div>
                <p className="text-xs font-semibold text-gray-400 dark:text-gray-500 uppercase tracking-wider mb-3">Contacto</p>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  <div>
                  ...
                  <div className="sm:col-span-2">
                    <label className="block text-xs font-semibold text-gray-500 dark:text-gray-400 mb-1.5">Dirección</label>
                    <input
                      type="text"
              ...
              {/* Info médica */}
              <div>
                <p className="text-xs font-semibold text-gray-400 dark:text-gray-500 uppercase tracking-wider mb-3">Información Médica</p>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  <div>
                    <label className="block text-xs font-semibold text-gray-500 dark:text-gray-400 mb-1.5">Grupo sanguíneo</label>
                    <select
                  ...
                  <div>
                    <label className="block text-xs font-semibold text-gray-500 dark:text-gray-400 mb-1.5">Seguro dental</label>
                    <input
                      type="text"
                  ...
                  <div>
                    <label className="block text-xs font-semibold text-gray-500 dark:text-gray-400 mb-1.5">Alergias</label>
                    <input
                      type="text"
                  ...
                  <div>
                    <label className="block text-xs font-semibold text-gray-500 dark:text-gray-400 mb-1.5">Condiciones médicas</label>
                    <input
                      type="text"
                  ...
                  <div className="sm:col-span-2">
                    <label className="block text-xs font-semibold text-gray-500 dark:text-gray-400 mb-1.5">Notas adicionales</label>
                    <textarea
                      rows={3}
                      placeholder="Observaciones relevantes para el expediente…"
                      value={newPatient.notes}
                      onChange={e => setNewPatient({ ...newPatient, notes: e.target.value })}
                      className="w-full px-3.5 py-2.5 text-sm border border-gray-200 rounded-xl bg-gray-50 focus:outline-none focus:ring-2 focus:ring-[#0066CC]/30 focus:border-[#0066CC] transition-all resize-none dark:border-gray-700 dark:bg-gray-800 dark:text-gray-100"
                    />
                  </div>
                </div>
              </div>
